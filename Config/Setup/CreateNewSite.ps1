# **********************************************************************************
#
#   Save this file within an Acumatica installation directory to create a new site
#    for the current version (default site/db is version number. Ex: V181040023)
#
#   Updated 06/12/2019
#
# **********************************************************************************
