...
namespace PX.Objects.FS
{
        ...
        where Where : class, IBqlWhere, new()
    {
        ...
        private void UpdateSalesPrices(PXCache cache, FSServiceContract fsServiceContractRow)
        {
            ...
            {
                fsSalesPriceRow.Mem_UnitPrice = GetSalesPrice(SalesPricesServices.Cache, fsSalesPriceRow) ?? 0.0m;
            ...
            {
                fsSalesPriceRow.Mem_UnitPrice = GetSalesPrice(SalesPricesInventoryItems.Cache, fsSalesPriceRow) ?? 0.0m;
        ...
        protected virtual void FSServiceContract_RowPersisting(PXCache cache, PXRowPersistingEventArgs e)
        {
            ...
            if (e.Operation == PXDBOperation.Delete)
            {
                ...
                ServiceContractScheduleEntryBase<RouteServiceContractScheduleEntry, FSSchedule, FSSchedule.scheduleID, FSSchedule.entityID>
                    routeServiceContractScheduleEntry =

                PXGraph.CreateInstance<ServiceContractScheduleEntryBase<RouteServiceContractScheduleEntry, FSSchedule, FSSchedule.scheduleID, FSSchedule.entityID>>();
        ...
        protected virtual void FSSalesPrice_RowSelecting(PXCache cache, PXRowSelectingEventArgs e)
        {
            ...
            if (ServiceContractRecords.Current != null)
            {
                ...
                {
                    fsSalesPriceRow.Mem_UnitPrice = GetSalesPrice(cache, fsSalesPriceRow) ?? 0.0m;
                }
            }
        }
            ...
            using (new PXConnectionScope())
            {
                ...
                var fsSODetRows = PXSelectJoin<FSSODet,
                                    ...
                                    .Select(this, fsContractPeriodDetRow.ServiceContractID,
                                                ...
                                                fsContractPeriodDetRow.SMEquipmentID, fsContractPeriodDetRow.SMEquipmentID).AsEnumerable();
