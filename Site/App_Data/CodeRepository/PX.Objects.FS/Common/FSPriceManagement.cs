    ...
    public class FSPriceManagement : PXGraph<FSPriceManagement>
    {
            ...
            bool catchSalesPriceException)
        {
            ...
            if (currencyInfo == null)
            {
                ...
                currencyInfo.BaseCuryID = companyRow.BaseCuryID;
                currencyInfo.CuryID = companyRow.BaseCuryID;
            ...
            salesPrice = GetCustomerContractPrice(cache, serviceContractID, billServiceContractID, billContractPeriodID, lineRelatedToContract, inventoryID);
            ...
            if (salesPrice == null)
            {
                ...
                DeterminePriceCode(cache, ref salesPriceSet, inventoryID);
            }
            else
            {
            ...
            bool catchSalesPriceException)
        {
            ...
            string priceType = CheckPriceByPriceType(
                                                     cache, 
                                                     custPriceClass, 
                                                     customerID, 
                                                     inventoryID,
            ...
            if (priceType == null)
            {
                ...
                {
                    priceType = CheckPriceByPriceType(
                                                      cache, 
                                                      custPriceClass, 
                                                      customerID, 
                                                      inventoryID, 
        ...
        private static string CheckPriceByPriceType(PXCache cache, string custPriceClass, int? customerID, int? inventoryID, string baseCuryID, string curyID, decimal? quantity, string uom, DateTime date, string type, ref string errorCode)
        {
            ...
            PXSelectBase<ARSalesPrice> salesPrice = new PXSelect<ARSalesPrice,
                                                        ...
                                                        OrderBy<Asc<ARSalesPrice.priceType, Desc<ARSalesPrice.isPromotionalPrice, Desc<ARSalesPrice.breakQty>>>>>(cache.Graph);
