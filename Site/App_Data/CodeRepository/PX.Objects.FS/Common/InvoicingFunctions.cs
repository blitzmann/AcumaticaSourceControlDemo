    ...
    public static class InvoicingFunctions
    {
        ...
        public static void CleanPostingInfoLinkedToDoc(object postedDoc)
        {
            ...
            else if (postedDoc is SOInvoice)
            {
                ...
                fsPostDetRows = PXSelect<FSPostDet, Where<FSPostDet.sOInvRefNbr, Equal<Required<FSPostDet.sOInvRefNbr>>,
                                                        And<FSPostDet.sOInvDocType, Equal<Required<FSPostDet.sOInvDocType>>>>>.Select(cleanerGraph, createdRefNbr, createdDocType);
            }
            else if (postedDoc is ARInvoice)
            {
        ...
        private static void GetShippingContactAddress(
            PXGraph graph,
