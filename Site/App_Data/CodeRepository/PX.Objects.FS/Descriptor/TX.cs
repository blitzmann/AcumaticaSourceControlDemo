...
namespace PX.Objects.FS
{
    public static class TX
    {
        ...
        public static class Error
        {
            ...
            public const string START_DATE_LESSER_THAN_PRESENT                                                 = "The dates are invalid. The start date and time cannot be earlier than the present date and time.";
            public const string SLAETA_GREATER_EQUAL_PROMISEDDATE                                              = "The SLA date must be later than or equal to the promised date.";
            public const string CUSTOMER_CHANGE_NOT_ALLOWED_APP_STATUS                                         = "The customer cannot be changed because the service order has ongoing appointments.";
            public const string CUSTOMER_CHANGE_NOT_ALLOWED_SO_STATUS                                          = "The customer cannot be changed because the service order status is not Open or On Hold.";
            public const string ACTUAL_DATES_APPOINTMENT_MISSING                                               = "The appointment cannot be completed. Fill in the boxes in the Actual Date and Time section.";
            public const string SERVICE_LICENSE_TYPES_REQUIREMENTS_MISSING                                     = "The employees assigned to the appointment do not have the licenses required for the services.";
            public const string SERVICE_SKILL_REQUIREMENTS_MISSING                                             = "The employee does not have skills required to complete the appointment service or services.";
            public const string SERVICE_SKILL_REQUIREMENTS_MISSING_GENERAL                                     = "The employees assigned to the appointment do not have skills required for the service.";
            public const string APPOINTMENT_EMPLOYEE_MISMATCH_GEOZONE                                          = "The employee is not assigned to work in this service area. The postal code of the appointment address is not included in the service area where this employee can work on the Service Areas(FS201900) form.";
            public const string EMPLOYEES_MISSING_TO_VALIDATE_SERVICES                                         = "The services cannot be validated because employees are not assigned to the appointment. Add at least one employee on the Employees tab.";
            public const string EMPLOYEES_MISSING_TO_VALIDATE_GEOZONE                                          = "The service area cannot be validated because employees are not assigned to the service order. Add at least one employee on the Employees tab.";
            public const string APPOINTMENT_START_VALIDATE_SERVICE                                             = "An appointment without services cannot be started. Add at least one service on the Services tab.";
            public const string APPOINTMENT_COMPLETE_VALIDATE_SERVICE                                          = "An appointment without services cannot be completed. Add at least one service on the  Services tab.";
            public const string SELECT_VALID_ACTION                                                            = "A valid action has to be selected.";
            public const string SIGNED_OFF_SERVICE                                                             = "This service order has already been signed.";
            public const string CHECKOUT_NEEDED_BEFORE_SIGNOFF                                                 = "You must check out the service order before signing it.";
            public const string CHECKED_OUT_SERVICE                                                            = "This service order has already been checked out.";
            public const string SIGNED_OFF_NEEDED_FOR_SERVICE                                                  = "The service order must be signed to create an invoice for it.";
            public const string CHECKOUT_AND_SIGNED_OFF_NEEDED_FOR_SERVICE                                     = "The service order must be checked out and signed to create an invoice for it.";
            public const string SERVICE_ORDER_ALREADY_POSTED                                                   = "The service order has already been posted to the sales order.";
            public const string SERVICE_ORDER_POSTING_INCONSISTENCY                                            = "Some of the detail lines of the service order have been posted but the corresponding records are missing or corrupted in the Control table. Please contact support service for assistance.";
            public const string SERVICE_ORDER_SOORDER_INCONSISTENCY                                            = "The service order has an invalid sales order reference. Please contact support service for assistance.";
            public const string SERVICE_ORDER_BILLCUSTOMER_MISSING                                             = "The billing customer has not been defined for the service order {0}. Assign it on the Service Orders (FS300100) form.";
            public const string SERVICE_ORDER_NOT_FOUND_IN_SERVICEORDERGRAPH                                   = "The service order cannot be updated because the ServiceOrderGraph was not loaded.";
            public const string RESOURCES_MISSING_TO_VALIDATE_SERVICES                                         = "The Services tab contains services that require one or more missing resources. Review the specific requirements for each service on the Services tab.";
            public const string QUOTE_SELECTION_NOT_ALLOWED                                                    = "The service order cannot be converted to quote because at least one appointment is scheduled for this service order.";
            public const string ATTENDEE_RECORD_REPEATED                                                       = "This attendee already exists.";
            public const string MINIMUN_VALUE                                                                  = "The minimum value allowed for {0} is {1}.";
            public const string MINIMUN_VALUE_NAME_FIELD                                                       = "The minimum value allowed for {0} is {1}";
            public const string EQUIPMENT_TYPE_MISSING                                                         = "The {1} resource type is missing a resource or multiple resources.";
            ...
            public const string SERVICE_ORDER_TYPE_NOT_FOUND                                                   = "The {0} service order type not found.";
            public const string SETUP_NOT_DEFINED                                                              = "The necessary settings are not defined on the Service Management Preferences (FS100100) form.";
            ...
            public const string CONTRACT_SRVORDTYPE_UNDEFINED                                                  = "Define the service order type for contracts on the Route Management Preferences (FS100400) form.";
            ...
            public const string EMAIL_CANNOT_BE_NULL_IF_SENDAPPNOTIFICATION_IS_TRUE                            = "The Email box has to be filled in if the Allow Appointment Notifications check box is selected.";
            ...
            public const string LICENSE_NEED_NUMBERING_ID                                                      = "The license numbering sequence has not been specified. Specify it in the License Numbering Sequence box on the Service Management Preferences (FS100100) form.";
            ...
            public const string RECORD_NOT_FOUND                                                               = "The {0} record was not found.";
            ...
            public const string EQUIPMENT_NUMBERING_SEQUENCE_MISSING_SETUP                                     = "You have to specify equipment numbering sequence on the Service Management Preferences (FS100100) form.";
            ...
            public const string ACTUAL_DATE_TIMES_ARE_REQUIRED                                                 = "At least one {0} actual start or end time is not provided. Provide the required value or values, or clear the Require Actual Start/End Time of Service Lines to Complete Appointment check box on the Time Behavior tab of the Service Order Types (FS202300) form for the service order type.";
            ...
            public const string DEFAULT_SERVICE_ORDER_TYPE_NOT_PROVIDED                                        = "The default service order type is not defined. Specify the default type in the Default Service Order Type box on the Service Management Preferences (FS100100) form.";
            ...
            public const string ADVANCED_SO_INVOICE_IS_DISABLED                                                = "The Advanced SO Invoices feature is disabled on the Enable/Disable Features (CS100000) form.";
            ...
            public const string PROCESSING_CONTRACT_SO_INVOICE_NOT_IMPLEMENTED                                 = "The ability to generate SO invoices for service contracts has not been implemented yet. Please select another option in the Invoice Generation Settings section on the Equipment Management Preferences (FS100300) form, or if you generate billing documents for route service contracts, on the Route Management Preferences (FS100400) form.";
            public const string CONTRACT_SO_INVOICE_NOT_IMPLEMENTED                                            = "The ability to generate SO invoices for service contracts has not been implemented yet. Please select another option.";
        }
        ...
        public static class Warning
        {
            ...
            public const string DEFAULT_EMAIL_NOT_CONFIGURED                                              = "The notification email related to the service order type cannot be sent because the default email address is not defined. Define it on the Email Preferences (SM204001) form.";
        ...
        public static class Batch_PostTo
        {
            ...
            public const string SI      = "SO Invoice";
        ...
        public static class CalendarMessages
        {
            ...
            public const string BUTTON_SHOW_ROUTE_INFO = "Show or Hide Route Appointment Information on the Map";
