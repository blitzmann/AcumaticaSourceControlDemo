...
namespace PX.Objects.FS
{
    ...
    {        
        ...
        public class SourceType_ServiceOrder
        {
            ...
            public readonly string[] TX_LIST = { PX.Objects.CR.Messages.Case, PX.Objects.CR.Messages.Opportunities, PX.Objects.IN.Messages.qadSOOrder, PX.Objects.IN.Messages.qadFSServiceOrder, PX.Objects.IN.Messages.qadFSServiceOrder };            
        }
        ...
        public class SrvOrdType_PostTo : Contract_PostTo
        {
            ...
            public new readonly string[] ID_LIST = { ID.SrvOrdType_PostTo.NONE, ID.SrvOrdType_PostTo.ACCOUNTS_RECEIVABLE_MODULE,
                                                    ID.SrvOrdType_PostTo.SALES_ORDER_MODULE, ID.SrvOrdType_PostTo.SALES_ORDER_INVOICE};
            public new readonly string[] TX_LIST = { TX.SrvOrdType_PostTo.NONE, TX.SrvOrdType_PostTo.ACCOUNTS_RECEIVABLE_MODULE,
                                                    TX.SrvOrdType_PostTo.SALES_ORDER_MODULE, TX.SrvOrdType_PostTo.SALES_ORDER_INVOICE};
        }
        ...
        public class Contract_PostTo
        {
            ...
            public readonly string[] ID_LIST = { ID.Contract_PostTo.ACCOUNTS_RECEIVABLE_MODULE, ID.Contract_PostTo.SALES_ORDER_MODULE,
                                                    ID.Contract_PostTo.SALES_ORDER_INVOICE};
        ...
        public class Batch_PostTo : Batch_PostTo_Filter
        {
            ...
            public new readonly string[] ID_LIST = { ID.Batch_PostTo.AR, ID.Batch_PostTo.SO, ID.Batch_PostTo.SI, ID.Batch_PostTo.AP, ID.Batch_PostTo.IN, ID.Batch_PostTo.AR_AP };
            public new readonly string[] TX_LIST = { TX.Batch_PostTo.AR, TX.Batch_PostTo.SO, TX.Batch_PostTo.SI, TX.Batch_PostTo.AP, TX.Batch_PostTo.IN, TX.Batch_PostTo.AR_AP };
        }
        ...
        public class Batch_PostTo_Filter
        {
            ...
            public readonly string[] ID_LIST = { ID.Batch_PostTo.AR_AP, ID.Batch_PostTo.SO, ID.Batch_PostTo.SI };
            public readonly string[] TX_LIST = { TX.Batch_PostTo.AR_AP, TX.Batch_PostTo.SO, TX.Batch_PostTo.SI };
        }
        ...
        public class DayResolution_Setup
        {
            ...
            {
                ID.DayResolution_Setup.D13, ID.DayResolution_Setup.D14, ID.DayResolution_Setup.D15,
                ID.DayResolution_Setup.D16, ID.DayResolution_Setup.D17, ID.DayResolution_Setup.D18,
                ID.DayResolution_Setup.D19
            };

            public readonly string[] TX_LIST =
            {
                TX.DayResolution_Setup.D13, TX.DayResolution_Setup.D14, TX.DayResolution_Setup.D15,
                TX.DayResolution_Setup.D16, TX.DayResolution_Setup.D17, TX.DayResolution_Setup.D18,
                TX.DayResolution_Setup.D19
            };
        }
        ...
        public class WeekResolution_Setup
        {
            ...
            public readonly int[] ID_LIST =
            {
                ID.WeekResolution_Setup.W10, ID.WeekResolution_Setup.W11, ID.WeekResolution_Setup.W12,
                ID.WeekResolution_Setup.W13, ID.WeekResolution_Setup.W14, ID.WeekResolution_Setup.W15,
                ID.WeekResolution_Setup.W16, ID.WeekResolution_Setup.W17, ID.WeekResolution_Setup.W18,
                ID.WeekResolution_Setup.W19
            };

            public readonly string[] TX_LIST =
            {
                TX.WeekResolution_Setup.W10, TX.WeekResolution_Setup.W11, TX.WeekResolution_Setup.W12,
                TX.WeekResolution_Setup.W13, TX.WeekResolution_Setup.W14, TX.WeekResolution_Setup.W15,
                TX.WeekResolution_Setup.W16, TX.WeekResolution_Setup.W17, TX.WeekResolution_Setup.W18,
                TX.WeekResolution_Setup.W19
            };
        }
        ...
        public class MonthResolution_Setup
        {
            ...
            public readonly int[] ID_LIST =
            {
                ID.MonthResolution_Setup.M06, ID.MonthResolution_Setup.M07, ID.MonthResolution_Setup.M08,
                ID.MonthResolution_Setup.M09, ID.MonthResolution_Setup.M10, ID.MonthResolution_Setup.M11,
                ID.MonthResolution_Setup.M12, ID.MonthResolution_Setup.M13, ID.MonthResolution_Setup.M14,
                ID.MonthResolution_Setup.M15, ID.MonthResolution_Setup.M16, ID.MonthResolution_Setup.M17,
                ID.MonthResolution_Setup.M18, ID.MonthResolution_Setup.M19
            };

            public readonly string[] TX_LIST =
            {
                TX.MonthResolution_Setup.M06, TX.MonthResolution_Setup.M07, TX.MonthResolution_Setup.M08,
                TX.MonthResolution_Setup.M09, TX.MonthResolution_Setup.M10, TX.MonthResolution_Setup.M11,
                TX.MonthResolution_Setup.M12, TX.MonthResolution_Setup.M13, TX.MonthResolution_Setup.M14,
                TX.MonthResolution_Setup.M15, TX.MonthResolution_Setup.M16, TX.MonthResolution_Setup.M17,
