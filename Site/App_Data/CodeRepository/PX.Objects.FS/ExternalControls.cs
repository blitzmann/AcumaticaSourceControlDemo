...
namespace PX.Objects.FS
{
    public class ExternalControls : PXGraph<ExternalControls>
    {
        ...
        public List<FSAppointmentScheduleBoard> UnassignedAppointmentRecords(DateTime timeBegin, DateTime timeEnd, int? branchID, int? branchLocationID, bool? unassignedAppointmentByRoom, DispatchBoardFilters[] filters)
        {
            ...
            PXSelectBase<FSAppointmentScheduleBoard> appointmentRecords = new PXSelect<FSAppointmentScheduleBoard,
                                               Where<
        ...
        public List<RouteNode> GetTreeAppointmentNodesByRoute(int routeDocumentID, FSRoute fsRouteRow)
        {
            ...
            foreach (PXResult<FSAppointment, FSServiceOrder, FSSrvOrdType, Location, FSAddress, Country, State, FSCustomer> bqlResult in results)
            {
                ...
                tmpLeaf.Add(new RouteNode(fsAppointmentRow, fsSrvOrdTypeRow, fsServiceOrderRow, fsCustomerRow, locationRow, fsAddressRow));
            }
        ...
        public List<RouteNode> GetTreeAppointmentNodesByEmployee(int employeeID, DateTime calendarDate)
        {
                              ...
                              FSCustomer> bqlResult in results)
            {
                ...
                //Appointment Tree Node 
                tmpLeaf.Add(new RouteNode(fsAppointmentRow, fsSrvOrdTypeRow, fsServiceOrderRow, fsCustomerRow, bAccountStaffMemberRow, locationRow, fsAddressRow));
            }
        ...
        public class RouteNode
        {
            ...
            public RouteNode(FSAppointment fsAppointmentRow, FSSrvOrdType fsSrvOrdTypeRow, FSServiceOrder fsServiceOrderRow, FSCustomer fsCustomerRow, BAccountStaffMember bAccountStaffMemberRow, Location locationRow, FSAddress fsAddressRow)
            {
                ...
                this.SetCommonAttributes(fsAppointmentRow, fsSrvOrdTypeRow, fsServiceOrderRow, fsCustomerRow, locationRow, fsAddressRow);
            }
            ...
            /// <param name="fsServiceOrderRow"> Service Order Record. </param>
            /// <param name="fsCustomerRow"> Customer Record. </param>
            public RouteNode(FSAppointment fsAppointmentRow, FSSrvOrdType fsSrvOrdTypeRow, FSServiceOrder fsServiceOrderRow, FSCustomer fsCustomerRow, Location locationRow, FSAddress fsAddressRow)
            {
            ...
            private void SetCommonAttributes(FSAppointment fsAppointmentRow, FSSrvOrdType fsSrvOrdTypeRow, FSServiceOrder fsServiceOrderRow, FSCustomer fsCustomerRow, Location locationRow, FSAddress fsAddressRow)
            {
