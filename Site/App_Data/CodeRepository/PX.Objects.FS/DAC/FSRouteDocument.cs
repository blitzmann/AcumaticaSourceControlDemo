...
namespace PX.Objects.FS
{
	...
	public class FSRouteDocument : PX.Data.IBqlTable
	{
        ...
        #region LabelWarning
        public abstract class labelWarning : PX.Data.BQL.BqlString.Field<labelWarning>
        {
        }
        protected String _LabelWarning;
        [PXString]
        [PXUIField]
        [PXDefault(TX.Warning.ROUTE_APPROXIMATE_VALUES, PersistingCheck = PXPersistingCheck.Nothing)]
        public virtual string LabelWarning
        {
            get
            {
