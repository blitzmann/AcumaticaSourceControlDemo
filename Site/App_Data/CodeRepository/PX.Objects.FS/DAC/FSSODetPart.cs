...
namespace PX.Objects.FS
{
    ...
    public class FSSODetPart : FSSODet
    {
        ...
        [PXDefault(typeof(Switch<
                            Case<
                                Where<
                                    ...
                                    Or<lineType, Equal<ListField_LineType_ALL.Instruction_Part>,
                                    Or<lineType, Equal<ListField_LineType_ALL.Comment_Part>>>>,
        ...
        [PXDefault(TypeCode.Decimal, "0.0")]
        [PXFormula(typeof(Default<FSSODetPart.isBillable, FSSODetPart.lineType>))]
        [PXFormula(typeof(Switch<
                                Case<
                                    Where<
