...
namespace PX.Objects.FS
{
    ...
    [Serializable]
    [PXCacheName(TX.TableName.APPOINTMENTDET_SERVICE)]
    public class FSAppointmentDetService : FSAppointmentDet
    {
        ...
        [PXDefault(typeof(Search<FSBranchLocation.dfltSiteID,
                   ...
                   PersistingCheck = PXPersistingCheck.Nothing)]
        [FSSiteAvailAttribute(typeof(FSAppointmentDetService.inventoryID), typeof(FSAppointmentDetService.subItemID), DisplayName = "Warehouse", Visible = false)]
        [PXFormula(typeof(Default<FSAppointmentDetService.inventoryID, FSAppointmentDetService.subItemID>))]
        ...
        [PXFormula(typeof(Default<FSAppointmentDetService.isBillable, FSAppointmentDetService.contractRelated, FSAppointmentDetService.lineType>))]
        [PXFormula(typeof(Switch<
                                Case<
                                    Where<
