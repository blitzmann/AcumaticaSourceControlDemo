...
namespace PX.Objects.PM
{
	...
	public static class Messages
	{
		...
		public const string DefaultAccountIsNotConfiguredForBilling = "The {0} billing rule has been configured to use the sales account from the account group, but the default account has not been specified for the {1} account group.";
		...
		public const string LockedBudgetLineCannotBeUpdated = "Original budgeted values of the selected project budget line have not been updated because the project budget is locked.";
