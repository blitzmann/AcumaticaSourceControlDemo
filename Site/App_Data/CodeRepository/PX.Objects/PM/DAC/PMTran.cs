...
namespace PX.Objects.PM
{
	...
	public partial class PMTran : PX.Data.IBqlTable, IProjectFilter, IQuantify
	{
		...
		#endregion
		#region TranCuryAmountNormal
		public abstract class tranCuryAmountNormal : PX.Data.BQL.BqlDecimal.Field<tranCuryAmountNormal>
		{
		}
		[PXCurrency(typeof(PMTran.baseCuryInfoID), typeof(PMTran.amountNormal))]
		[PXDefault(TypeCode.Decimal, "0.0", PersistingCheck = PXPersistingCheck.Nothing)]
		[PXUIField(DisplayName = "Amount (Normal)")]
		public virtual decimal? TranCuryAmountNormal
		{
			get;
			set;
		}
		#endregion
		#region AmountNormal
		public abstract class amountNormal : PX.Data.BQL.BqlDecimal.Field<amountNormal>
		{
		}
		[PXBaseCury]
		[PXDefault(TypeCode.Decimal, "0.0", PersistingCheck = PXPersistingCheck.Nothing)]
