...
namespace PX.Objects.Common.Discount.Mappers
{
	public abstract class AmountLineFields : DiscountedLineMapperBase
	{
		...
		private static AmountLineFields GetMapFor(object line, PXCache cache, Type lineType)
		{
			...
			{
				return DiscountEngine.ApplyQuantityDiscountByBaseUOMForAR(cache.Graph)
					? (AmountLineFields)new AmountLineFields<SOLine.baseOrderQty, SOLine.curyUnitPrice, SOLine.curyExtPrice, SOLine.curyLineAmt, SOLine.uOM, origGroupDiscountRate, origDocumentDiscountRate, SOLine.groupDiscountRate, SOLine.documentDiscountRate, SOLine.freezeManualDisc>(cache, line)
			...
			return DiscountEngine.ApplyQuantityDiscountByBaseUOMForAR(cache.Graph)
				? (AmountLineFields)new AmountLineFields<baseOrderQty, curyUnitPrice, curyExtPrice, curyLineAmt, uOM, origGroupDiscountRate, origDocumentDiscountRate, groupDiscountRate, documentDiscountRate, freezeManualDisc>(cache, line)
