...
namespace PX.Objects.PO
{
	...
	public partial class POReceiptLine : PX.Data.IBqlTable, ILSPrimary, ISortOrder, IPOReturnLineSource
	{
		...
		[Account(typeof(POReceiptLine.branchID),DisplayName = "Account", Visibility = PXUIVisibility.Visible, Filterable = false, DescriptionField = typeof(Account.description), Visible = false, SuppressCurrencyValidation = true)]
		[PXDefault(PersistingCheck = PXPersistingCheck.Nothing)]
