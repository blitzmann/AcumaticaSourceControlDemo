namespace PX.Objects.IN
{
	...
	public partial class INItemPlan : PX.Data.IBqlTable, IQtyPlanned
	{
		...
		public static class FK
		{
			...
			public class OrigItemPlan : INItemPlan.PK.ForeignKeyOf<INItemPlan>.By<origPlanID> { }
			public class SupplyItemPlan : INItemPlan.PK.ForeignKeyOf<INItemPlan>.By<supplyPlanID> { }
			public class DemandItemPlan : INItemPlan.PK.ForeignKeyOf<INItemPlan>.By<demandPlanID> { }
	...
	{
		#region PlanID
		public new abstract class planID : IBqlField
		{
		}
		#endregion
	}
