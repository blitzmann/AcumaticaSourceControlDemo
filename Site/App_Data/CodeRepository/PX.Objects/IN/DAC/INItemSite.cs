...
namespace PX.Objects.IN
{
	...
	public partial class INItemSite : PX.Data.IBqlTable
	{
		...
		#endregion
		#region NegativeCost
		// The filed was copied to INItemSiteSettings and the single usage was corrected.
		// Looks that field in this DAC is not used any more.
		[Obsolete("Will be removed in future versions of Acumatica. Please use INItemSiteSettings.negativeCost instead.")]
