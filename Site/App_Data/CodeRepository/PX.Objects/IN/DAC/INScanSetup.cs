...
namespace PX.Objects.IN
{
	...
	public class INScanSetup : IBqlTable
	{
		...
		[PXDBBool]
		[PXDefault(false)]
		[PXUIField(DisplayName = "Use Default Quantity in Receipt")]
		...
		[PXDBBool]
		[PXDefault(false)]
		[PXUIField(DisplayName = "Use Default Quantity in Issue")]
		...
		[PXDBBool]
		[PXDefault(false)]
		[PXUIField(DisplayName = "Use Default Quantity in Transfer")]
		...
		[PXDBBool]
		[PXDefault(false)]
		[PXUIField(DisplayName = "Use Default Quantity in Count")]
