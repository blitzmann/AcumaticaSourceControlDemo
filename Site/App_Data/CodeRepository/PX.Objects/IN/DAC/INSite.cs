...
namespace PX.Objects.IN
{
	...
	public partial class INSite : PX.Data.IBqlTable, PX.SM.IIncludable
	{
		...
		public static class FK
		{
			...
			public class DiscSub : Sub.PK.ForeignKeyOf<INSite>.By<discSubID> { }
			public class FreightSub : Sub.PK.ForeignKeyOf<INSite>.By<freightSubID> { }
			public class MiscSub : Sub.PK.ForeignKeyOf<INSite>.By<miscSubID> { }
		...
		#endregion
		#region DiscAcctID
		public abstract class discAcctID : PX.Data.BQL.BqlInt.Field<discAcctID> { }
		...
		[PXForeignReference(typeof(Field<INSite.discAcctID>.IsRelatedTo<Account.accountID>))]
		...
		#endregion
		#region DiscSubID
		public abstract class discSubID : PX.Data.BQL.BqlInt.Field<discSubID> { }
		...
		[PXForeignReference(typeof(Field<INSite.discSubID>.IsRelatedTo<Sub.subID>))]
		...
		[PXForeignReference(typeof(Field<INSite.freightAcctID>.IsRelatedTo<Account.accountID>))]
		...
		[PXForeignReference(typeof(Field<INSite.freightSubID>.IsRelatedTo<Sub.subID>))]
		...
		[PXForeignReference(typeof(Field<INSite.miscAcctID>.IsRelatedTo<Account.accountID>))]
		...
		[PXForeignReference(typeof(Field<INSite.miscSubID>.IsRelatedTo<Sub.subID>))]
