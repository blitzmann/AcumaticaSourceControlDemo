...
namespace PX.Objects.IN
{
	...
	public class INScanCount : WMSBase
	{
		...
		protected override void _(Events.RowSelected<Header> e)
		{
			...
			ScanRemove.SetEnabled(IsDocumentEditable && e.Row != null && e.Row.ScanState.IsIn(ScanStates.Location, ScanStates.Item) &&
				Base.PIDetail.SelectMain().AsEnumerable().Any(d => (d.PhysicalQty ?? 0) != 0));
