...
namespace PX.Objects.IN
{
	public class INSetupMaint : PXGraph<INSetupMaint>, IFeatureAccessProvider
	{
		...
		protected virtual void INSetup_RowSelected(PXCache sender, PXRowSelectedEventArgs e)
		{
			...
			{
                InventoryItem itemWeight = PXSelectReadonly<InventoryItem, Where<InventoryItem.weightUOM, IsNotNull,
			...
			{
				InventoryItem itemVolume = PXSelectReadonly<InventoryItem, Where<InventoryItem.volumeUOM, IsNotNull,
