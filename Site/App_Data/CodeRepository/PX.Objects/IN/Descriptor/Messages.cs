...
namespace PX.Objects.IN
{
	...
	public static class Messages
	{
		...
		public const string LotSerIssueMethodCannotBeChangedShipment = "The issue method for the {0} lot/serial class cannot be changed because the {1} shipment contains the {2} item with the serial number of this class.";
