...
namespace PX.Objects.CR
{
	...
	public partial class BAccount : IBqlTable, IAssign, IPXSelectable, INotable
	{
		...
		#region HubSpotID
		public abstract class hubSpotID : PX.Data.BQL.BqlInt.Field<hubSpotID> { }
		[PXDBInt]
		[PXDefault(PersistingCheck = PXPersistingCheck.Nothing)]
		[PXUIField(DisplayName = "HubSpot ID", Visibility = PXUIVisibility.Dynamic, Visible = false)]
		public virtual int? HubSpotID { get; set; }
		#endregion
	}
