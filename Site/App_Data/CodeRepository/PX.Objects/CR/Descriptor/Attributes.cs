...
namespace PX.Objects.CR
{
    ...
    public class LeadStatusesAttribute : PXStringListAttribute
    {
        ...
        public sealed class @new : PX.Data.BQL.BqlString.Constant<@new>
		{
            public @new() : base(New) { }
        }
	...
	public class CRCaseMajorStatusesAttribute : PXIntListAttribute
	{
		...
		public sealed class justCreated : PX.Data.BQL.BqlInt.Constant<justCreated>
		{
			public justCreated() : base(_JUST_CREATED) { }
		}

		public sealed class @new : PX.Data.BQL.BqlInt.Constant<@new>
		{
			public @new() : base(_NEW) { }
		}

		public sealed class pendingCustomer : PX.Data.BQL.BqlInt.Constant<pendingCustomer>
		{
		...
		public class pendingClosure : PX.Data.BQL.BqlInt.Constant<pendingClosure>
		{
	...
	public class CRCaseStatusesAttribute : PXStringListAttribute
	{
		...
		public sealed class PendingCustomer : PX.Data.BQL.BqlString.Constant<PendingCustomer>
		{
			public PendingCustomer() : base(_PENDING_CUSTOMER) { }
		}
	...
	public sealed class CRCaseResolutionsAttribute : PXStringListAttribute
	{
		...
		public sealed class CustomerPreclosed : PX.Data.BQL.BqlString.Constant<CustomerPreclosed>
		{
			public CustomerPreclosed() : base(_CUSTOMER_PRECLOSED) { }
		}

		public sealed class CustomerReplied : PX.Data.BQL.BqlString.Constant<CustomerReplied>
		{
			public CustomerReplied() : base(_CUSTOMER_REPLIED) { }
		}

		public sealed class Resolved : PX.Data.BQL.BqlString.Constant<Resolved>
		{
			public Resolved() : base(_RESOLVED) { }
		}

		public sealed class Assigned : PX.Data.BQL.BqlString.Constant<Assigned>
		{
			public Assigned() : base(_ASSIGNED) { }
		}

		public sealed class Unassigned : PX.Data.BQL.BqlString.Constant<Unassigned>
		{
			public Unassigned() : base(_UNASSIGNED) { }
		}

		public sealed class Updated : PX.Data.BQL.BqlString.Constant<Updated>
		{
	...
	public class OpportunityResolusionAttribute : PXStringListAttribute
	{
		...
		public sealed class Unassign : PX.Data.BQL.BqlString.Constant<Unassign>
		{
			public Unassign() : base(_UNASSIGN) { }
		}

		public sealed class Assign : PX.Data.BQL.BqlString.Constant<Assign>
		{
		...
		public sealed class InProcess : PX.Data.BQL.BqlString.Constant<InProcess>
		{
			public InProcess() : base(_INPROCESS) { }
		}

		public sealed class Functionality : PX.Data.BQL.BqlString.Constant<Functionality>
		{
			public Functionality() : base(_FUNCTIONALITY) { }
		}

		public sealed class CompanyMaturity : PX.Data.BQL.BqlString.Constant<CompanyMaturity>
		{
			public CompanyMaturity() : base(_COMPANYMATURITY) { }
		}

		public sealed class Price : PX.Data.BQL.BqlString.Constant<Price>
		{
			public Price() : base(_PRICE) { }
		}

		public sealed class Other : PX.Data.BQL.BqlString.Constant<Other>
		{
			public Other() : base(_OTHER) { }
		}

		public sealed class Cancelled : PX.Data.BQL.BqlString.Constant<Cancelled>
		{
			public Cancelled() : base(_CANCELLED) { }
		}

		public sealed class Technology : PX.Data.BQL.BqlString.Constant<Technology>
		{
			public Technology() : base(_TECHNOLOGY) { }
		}

		public sealed class Relationship : PX.Data.BQL.BqlString.Constant<Relationship>
		{
	...
	public class OpportunityMajorStatusesAttribute : PXIntListAttribute
	{
		...
		public sealed class open : PX.Data.BQL.BqlInt.Constant<open>
		{
			public open() : base(_OPEN) { }
		}

		public sealed class suspend : PX.Data.BQL.BqlInt.Constant<suspend>
		{
			public suspend() : base(_SUSPEND) { }
		}

		public sealed class closed : PX.Data.BQL.BqlInt.Constant<closed>
		{
			public closed() : base(_CLOSED) { }
		}

		public sealed class newAssign : PX.Data.BQL.BqlInt.Constant<newAssign>
		{
			public newAssign() : base(_NEWASSIGNED) { }
		}

		public sealed class newReject : PX.Data.BQL.BqlInt.Constant<newReject>
		{
			public newReject() : base(_NEWREJECTED) { }
		}

		public sealed class newAssignedToOwner : PX.Data.BQL.BqlInt.Constant<newAssignedToOwner>
		{
			public newAssignedToOwner() : base(_NEWASSIGNEDTOOWNER) { }
		}

		public sealed class NewRegectedToOwner : PX.Data.BQL.BqlInt.Constant<NewRegectedToOwner>
		{
