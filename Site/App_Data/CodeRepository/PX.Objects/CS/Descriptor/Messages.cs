...
namespace PX.Objects.CS
{
	...
	public static class Messages
	{
		...
		public const string LowQtyDecimalPrecision = "Setting Quantity Decimal Precision to 0 with Multiple Units of Measure feature enabled could result in incorrect UOM conversions.";
