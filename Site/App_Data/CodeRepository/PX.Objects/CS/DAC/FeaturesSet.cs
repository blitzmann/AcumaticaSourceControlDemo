...
namespace PX.Objects.CS
{
	...
	public class FeaturesSet : IBqlTable
	{
		...
		[PXUIEnabled(typeof(Where<FeaturesSet.branch, Equal<True>, And<FeaturesSet.multipleCalendarsSupport, NotEqual<True>>>))]
		...
		[PXUIEnabled(typeof(Where<FeaturesSet.centralizedPeriodsManagement, NotEqual<True>>))]
		...
		[Feature(false, typeof(FeaturesSet.financialAdvanced), DisplayName = "Payment Application per Line", Visible = false)]
        ...
        public abstract class distributionStandard : PX.Data.BQL.BqlBool.Field<distributionStandard> { }
        ...
        public abstract class distributionAdvanced : PX.Data.BQL.BqlBool.Field<distributionAdvanced> { }
		...
		[Feature(false, typeof(FeaturesSet.distributionAdvanced), DisplayName = "Automated Warehouse Operations")]
		...
		[Feature(false, typeof(FeaturesSet.advancedFulfillment), DisplayName = "Base Inventory")]
