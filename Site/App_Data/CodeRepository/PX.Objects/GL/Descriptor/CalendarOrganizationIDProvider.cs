...
namespace PX.Objects.GL.Descriptor
{
        ...
        ICalendarOrganizationIDProvider
    {
            ...
            bool takeOrganizationForSelectorFromQueryParams)
        {
            ...
            if (IsIDsUndefined(keyWithSourceValuesItem.KeyOrganizationIDs) && UseMasterOrganizationIDByDefault)
            {
        ...
        public virtual List<int?> GetDetailOrganizationIDs(PXGraph graph)
        {
            ...
            {
                //TODO Pank 444 GetDetailOrganizationIDs PXException?
                return new List<int?>();
                //throw new PXException(
                //    Messages.DocumentGraphExtensionIsNotDefined,
