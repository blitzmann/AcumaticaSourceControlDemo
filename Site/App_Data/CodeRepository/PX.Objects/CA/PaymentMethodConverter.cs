		...
		public partial class Filter : IBqlTable
		{
			...
			[PXDefault(typeof(Search2<CCProcessingCenterPmntMethod.processingCenterID,
				...
				Where<PaymentMethod.paymentMethodID, Equal<Current<Filter.oldPaymentMethodID>>,
					...
					And<CCProcessingCenter.processingTypeName, In3<AuthnetProcCenterTypeName.AIMPluginFullName, AuthnetProcCenterTypeName.CIMPluginFullName>>>>>))]
			...
			[PXDBString(10, IsUnicode = true)]
			[PXDefault()]
			[PXSelector(typeof(Search<CCProcessingCenter.processingCenterID, Where<CCProcessingCenter.processingTypeName, Equal<AuthnetProcCenterTypeName.APIPluginFullName>>>))]
