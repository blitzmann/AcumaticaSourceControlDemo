...
namespace PX.Objects.AP
{
	...
	public static class Messages
	{
		...
		public const string PaymentsByLinesDiscountsNotSupported = "Group and document discounts are not supported when the Pay per Line check box is selected.";
		public const string PaymentsByLinesTaxesNotSupported = "Taxes are not supported when the Pay per Line check box is selected.";
