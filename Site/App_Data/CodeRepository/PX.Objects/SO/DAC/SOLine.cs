...
namespace PX.Objects.SO
{
	...
	public partial class SOLine : PX.Data.IBqlTable, ILSPrimary, IHasMinGrossProfit, ISortOrder
	{
		...
		[PXDBPriceCostCalced(typeof(
			SOLine.curyUnitPrice.Multiply<decimal1.Subtract<discPct.Divide<decimal100>>>.When<SOLine.discPct.IsNotEqual<decimal0>>.
			Else<decimal0>.When<SOLine.orderQty.IsEqual<decimal0>>.
			Else<SOLine.curyUnitPrice>.When<SOLine.manualPrice.IsEqual<False>>.
			Else<SOLine.curyExtPrice.Subtract<SOLine.curyDiscAmt>.Divide<SOLine.orderQty>>), typeof(Decimal), CastToScale = 9, CastToPrecision = 25)]
		[PXFormula(typeof(
			SOLine.curyUnitPrice.Multiply<decimal1.Subtract<discPct.Divide<decimal100>>>.When<SOLine.discPct.IsNotEqual<decimal0>>.
			Else<SOLine.curyUnitPrice>.When<SOLine.manualPrice.IsEqual<False>>.
			Else<SOLine.curyExtPrice.Subtract<SOLine.curyDiscAmt>.Divide<SOLine.orderQty.NullIf<decimal0>>>))]
