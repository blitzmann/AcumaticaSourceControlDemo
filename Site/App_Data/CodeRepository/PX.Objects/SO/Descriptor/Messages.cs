...
namespace PX.Objects.SO
{
	...
	public static class Messages
	{
		...
		public const string LowQuantityPrecision = "Setting the quantity decimal precision to 0 with the Multiple Units of Measure feature enabled could result in incorrect UOM conversions. The decimal precision for quantity values is too low to perform UOM conversion for the item {0} without loss of quantity. Increase the quantity decimal precision, or use another UOM.";
