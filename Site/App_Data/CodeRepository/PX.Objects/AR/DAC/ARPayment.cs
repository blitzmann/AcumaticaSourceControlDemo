	...
	public class ARPayment : ARRegister, IInvoice, ICCPayment, IApprovable, IApprovalDescription
	{
		...
		[PXDefault(typeof(Coalesce<
			Search2<CCProcessingCenterPmntMethod.processingCenterID,
				InnerJoin<CustomerPaymentMethod,On<CustomerPaymentMethod.cCProcessingCenterID,Equal<CCProcessingCenterPmntMethod.processingCenterID>>>,
			...
			Search2<CCProcessingCenterPmntMethod.processingCenterID,
				...
				Where<CCProcessingCenterPmntMethod.paymentMethodID, Equal<Current<ARPayment.paymentMethodID>>,
					...
					And<CCProcessingCenterPmntMethod.isDefault, Equal<True>>>>>>), PersistingCheck = PXPersistingCheck.Nothing)]
		[PXSelector(typeof(Search2<
			...
			InnerJoin<PaymentMethod,On<PaymentMethod.paymentMethodID, Equal<CCProcessingCenterPmntMethod.paymentMethodID>>>>,
			Where<CCProcessingCenterPmntMethod.paymentMethodID, Equal<Current<ARPayment.paymentMethodID>>,
				And<CCProcessingCenterPmntMethod.isActive, Equal<True>>>>), DescriptionField = typeof(CCProcessingCenter.name))]
