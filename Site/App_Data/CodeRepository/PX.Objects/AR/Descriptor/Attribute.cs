...
namespace PX.Objects.AR
{
	...
	public class ARTaxAttribute : TaxAttribute
	{
		...
		public ARTaxAttribute(Type ParentType, Type TaxType, Type TaxSumType = null, Type parentBranchIDField = null)
			: base(ParentType, TaxType, TaxSumType, null, parentBranchIDField)
		{
	...
	public class ARPaymentChargeSelect<PaymentTable, PaymentMethodID, CashAccountID, AdjDate, AdjTranPeriodID, PMInstanceID, WhereSelect> :
		AP.PaymentChargeSelect<PaymentTable, PaymentMethodID, CashAccountID, AdjDate, AdjTranPeriodID,
