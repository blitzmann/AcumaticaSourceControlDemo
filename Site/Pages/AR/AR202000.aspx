        ...
        <Levels>
            <px:PXGridLevel DataMember="Records">
                ...
                <Columns>
					...
					<px:PXGridColumn DataField="IsFairValue" Width="90px" Type="CheckBox" TextAlign="Center" CommitChanges="true" />
					<px:PXGridColumn DataField="IsProrated" Width="90px" Type="CheckBox" TextAlign="Center" CommitChanges="true" />
