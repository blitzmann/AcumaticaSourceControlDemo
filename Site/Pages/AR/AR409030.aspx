		...
		<Levels>
			<px:PXGridLevel DataMember="Rows">
				...
				<Columns>
					...
					<px:PXGridColumn DataField="FinPeriodID" Width="60px" TextAlign="Center"/>
					<px:PXGridColumn DataField="GLTurnover" TextAlign="Right" Width="100px" />
					<px:PXGridColumn DataField="XXTurnover" TextAlign="Right" Width="100px" />
