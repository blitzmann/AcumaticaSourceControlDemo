        ...
        <Items>
            <px:PXTabItem Text="General Settings">
                <Template>
					...
					<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Fulfillment Workflow" />
					<px:PXFormView ID="formScanSetup" runat="server" DataSourceID="ds" Width="100%" DataMember="PickPackShipSetup" DefaultControlID="edShowPickTab" RenderStyle="Simple">
						<Template>
							...
							<px:PXCheckBox ID="edShowPickTab" runat="server" DataField="ShowPickTab" CommitChanges="true" />
							<px:PXCheckBox ID="edShowPackTab" runat="server" DataField="ShowPackTab" CommitChanges="true" />
							<px:PXCheckBox ID="edShowShipTab" runat="server" DataField="ShowShipTab" CommitChanges="true" />
							<px:PXCheckBox ID="edShowScanLogTab" runat="server" DataField="ShowScanLogTab" />

							<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Fulfillment Settings" SuppressLabel="True" />
							...
							<px:PXCheckBox ID="edUseCartsForPick" runat="server" DataField="UseCartsForPick" />
