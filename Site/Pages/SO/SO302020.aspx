                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Picked">
                                ...
                                <RowTemplate>
                                    ...
                                    <px:PXTextEdit ID="edPickOrigOrderNbr" runat="server" DataField="SOShipLine__OrigOrderNbr" Enabled="False"/>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="PickedForPack">
                                ...
                                <RowTemplate>
                                    ...
                                    <px:PXTextEdit ID="edPackOrigOrderNbr" runat="server" DataField="SOShipLine__OrigOrderNbr" Enabled="False" />
                                    ...
                                    <px:PXSelector ID="edPackLotSerialNbr" runat="server" DataField="LotSerialNbr" Enabled="False" />
    ...
    <px:PXSmartPanel ID="PanelSettings" runat="server" Caption="Settings" CaptionVisible="True" ShowAfterLoad="true"
        ...
        <px:PXFormView ID="frmSettings" runat="server" DataSourceID="ds" DataMember="UserSetupView" SkinID="Transparent">
            <Template>
                ...
                <px:PXSelector ID="edScaleID" runat="server" DataField="ScaleID" CommitChanges="true" AutoComplete="false" />
