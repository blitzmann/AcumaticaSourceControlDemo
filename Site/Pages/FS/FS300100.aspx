...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    ...
    <%--/Service Order Type Selector--%>
    <px:PXFormView ID="mainForm" runat="server" DataSourceID="ds" Width="100%" Caption="Service Order" MarkRequired="Dynamic" NotifyIndicator="True" FilesIndicator="True" ActivityIndicator="True" DataMember="ServiceOrderRecords" TabIndex="100" DefaultControlID="edCustomerID">
        <Template>
                    ...
                    <px:PXFormView ID="edServiceOrder_Address" runat="server" Caption="Address" DataMember="ServiceOrder_Address" DataSourceID="ds" RenderStyle="Fieldset">
                        <Template>
                          <px:PXFormView ID="edRoomForm" runat="server" DataMember="CurrentServiceOrder" DataSourceID="ds" RenderStyle="Simple">
                           ...
                           <px:PXMaskEdit ID="edPostalCode" runat="server" DataField="PostalCode" Width="120px" CommitChanges="True" />
                           <px:PXButton ID="btnViewDirectionOnMap" runat="server" CommandName="ViewDirectionOnMap" CommandSourceID="ds" Width="124px" Text="View On Map" />
                           <px:PXLayoutRule runat="server"/>
                       </Template>
                       <ContentStyle BackColor="Transparent" BorderStyle="None"/>
                    </px:PXFormView>
                ...
                <px:PXPanel ID="PXPanel1" runat="server" SkinID="transparent">
                    ...
                    RenderStyle="Fieldset">
                        <Template>
                            ...
                            <px:PXSelector ID="edScheduleID" runat="server" DataField="ScheduleID" AllowEdit="True" Enabled="False">
                            </px:PXSelector>
