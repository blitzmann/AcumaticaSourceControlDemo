...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" Width="100%" DataMember="Transfer" Caption="Transfer summary" NoteIndicator="True" FilesIndicator="True" ActivityIndicator="True" ActivityField="NoteActivity" LinkIndicator="True"
		...
		<Template>
            ...
            <px:PXSelector CommitChanges="True" ID="edFinPeriodID" runat="server" DataField="OutPeriodID" />
		...
		<Levels>
			<px:PXGridLevel DataMember="Expenses">
				<Columns>
					...
					<px:PXGridColumn DataField="EntryTypeID" Width="90px" CommitChanges="true"/>
					<px:PXGridColumn DataField="TranDesc" Width="90px" />
					<px:PXGridColumn DataField="CuryTranAmt" Width="90px" CommitChanges="true"/>
					<px:PXGridColumn DataField="CuryID" Width="90px" />
					<px:PXGridColumn DataField="AdjCuryRate" Width="90px" CommitChanges="true"/>
					<px:PXGridColumn DataField="ExtRefNbr" Width="90px" />
					<px:PXGridColumn DataField="AccountID" Width="90px" CommitChanges="true"/>
					<px:PXGridColumn DataField="SubID" Width="90px" CommitChanges="true"/>
					<px:PXGridColumn DataField="TranDate" Width="90px" CommitChanges="true"/>
					<px:PXGridColumn DataField="FinPeriodID" Width="90px" CommitChanges="true"/>
