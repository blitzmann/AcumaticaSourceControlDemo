    ...
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Height="150px" Style="z-index: 100" Width="100%" ActionsPosition="Top"
        ...
        <Levels>
            <px:PXGridLevel DataMember="Items" Visible="True">
                ...
                <Columns>
                    <px:PXGridColumn DataField="ProjectTask" Width="120px" AllowFilter="false" />
                    <px:PXGridColumn DataField="AccountGroup" Width="120px" AllowFilter="false"/>
                    <px:PXGridColumn DataField="Inventory" Width="120px" AllowFilter="false"/>
                    <px:PXGridColumn DataField="CostCode" Width="120px" AllowFilter="false"/>
                    <px:PXGridColumn DataField="Description" Width="208px" AllowFilter="false"/>
                    <px:PXGridColumn DataField="PlannedStartDate" Width="81px" AllowFilter="false"/>
                    <px:PXGridColumn DataField="PlannedEndDate" Width="81px" AllowFilter="false"/>
                    <px:PXGridColumn DataField="Period" Width="81px" AllowSort="false" AllowFilter="false" />
                    <px:PXGridColumn DataField="Qty" Width="81px" CommitChanges="true" AllowSort="false" AllowFilter="false"/>
                    <px:PXGridColumn DataField="CuryAmount" Width="81px" CommitChanges="true" AllowSort="false" AllowFilter="false"/>
                    <px:PXGridColumn DataField="RevisedQty" Width="81px" CommitChanges="true" AllowSort="false" AllowFilter="false"/>
                    <px:PXGridColumn DataField="CuryRevisedAmount" Width="81px" CommitChanges="true" AllowSort="false" AllowFilter="false"/>
                    <px:PXGridColumn DataField="ChangeOrderQty" Width="81px" AllowSort="false" AllowFilter="false"/>
                    <px:PXGridColumn DataField="CuryChangeOrderAmount" Width="81px" AllowSort="false" AllowFilter="false"/>
                    <px:PXGridColumn DataField="ActualQty" Width="81px" AllowSort="false" AllowFilter="false"/>
                    <px:PXGridColumn DataField="CuryActualAmount" Width="81px" AllowSort="false" AllowFilter="false"/>
                    <px:PXGridColumn DataField="VarianceQuantity" Width="81px" AllowSort="false" AllowFilter="false"/>
                    <px:PXGridColumn DataField="CuryVarianceAmount" Width="81px" AllowSort="false" AllowFilter="false"/>
                </Columns>
            </px:PXGridLevel>
        </Levels>
        <ActionBar>
    ...
    <px:PXSmartPanel ID="PanelCopyRevision" runat="server" Style="z-index: 108; position: absolute; left: 27px; top: 99px;" Caption="Copy Revision"
		...
		<px:PXFormView ID="formNewRevision" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Caption="New Revision" CaptionVisible="False" SkinID="Transparent"
			...
			<Template>
				...
				<px:PXTextEdit CommitChanges="True" ID="edRevisionID" runat="server" DataField="RevisionID" />
           </Template>
        </px:PXFormView>
		<div style="padding: 5px; text-align: right;">
