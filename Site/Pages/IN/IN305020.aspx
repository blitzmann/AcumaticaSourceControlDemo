...
<asp:content id="cont1" contentplaceholderid="phDS" runat="Server">
    <script language="javascript" type="text/javascript">
        ...
        function ActionCallback(callbackContext) {
            ...
            if ((callbackContext.info.name == "scan" || callbackContext.info.name == "ElapsedTime") && callbackContext.control.longRunInProcess == null && edInfoMessageSoundFile != null) {
    ...
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.IN.INScanCountHost" PrimaryView="HeaderView">
        <CallbackCommands>
			...
			<px:PXDSCallbackCommand Name="ScanConfirmDocument" Visible="true" CommitChanges="True" />
			<px:PXDSCallbackCommand Name="Review" CommitChanges="True" />
        </CallbackCommands>
    </px:PXDataSource>
</asp:content>
<asp:content id="cont2" contentplaceholderid="phF" runat="Server">
    <px:PXFormView ID="formHeader" runat="server" DataSourceID="ds" Height="100px" Width="100%" Visible="true" DataMember="HeaderView" DefaultControlID="edBarcode">
        <Template>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="PIDetail">
                                <Columns>
									...
									<px:PXGridColumn DataField="BookQty" Width="65px" TextAlign="Right" />
									<px:PXGridColumn DataField="PhysicalQty" Width="65px" TextAlign="Right" />
									<px:PXGridColumn DataField="VarQty" Width="65px" TextAlign="Right" />
                                </Columns>
                                <RowTemplate>
