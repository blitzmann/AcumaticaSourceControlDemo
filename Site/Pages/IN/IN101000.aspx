		...
		<Items>
			<px:PXTabItem Text="General Settings">
				<Template>
					...
					<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Inventory Operations Settings" />
					<px:PXFormView ID="formScanSetup" runat="server" DataSourceID="ds" Width="100%" DataMember="ScanSetup" DefaultControlID="edUseDefaultQtyInReceipt" RenderStyle="Simple">
						<Template>
							...
							<px:PXCheckBox ID="edUseDefaultQtyInReceipt" runat="server" DataField="UseDefaultQtyInReceipt" CommitChanges="true" />
							<px:PXCheckBox ID="edUseDefaultQtyInIssue" runat="server" DataField="UseDefaultQtyInIssue" CommitChanges="true" />
							<px:PXCheckBox ID="edUseDefaultQtyInTransfer" runat="server" DataField="UseDefaultQtyInTransfer" CommitChanges="true" />
							<px:PXCheckBox ID="edUseDefaultQtyInCount" runat="server" DataField="UseDefaultQtyInCount" CommitChanges="true" />
							<px:PXCheckBox ID="edExplicitLineConfirmation" runat="server" DataField="ExplicitLineConfirmation" />
							<px:PXCheckBox ID="edUseCartsForTransfers" runat="server" DataField="UseCartsForTransfers" />
